...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_HELIOS_NRF52840, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_VID, 0x366c);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x17da);
